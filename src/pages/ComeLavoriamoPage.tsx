      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-dark">
        ...
        <div className="container relative z-10 pt-32 pb-20 text-center">
          <div className="max-w-5xl mx-auto">
            ...
            <motion.h1 
              className="text-white mb-8 text-5xl md:text-7xl font-heading"
              initial={{ opacity: 0, y: 50 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.p 
              className="text-xl md:text-2xl text-light/70 font-light max-w-3xl mx-auto mb-12 leading-relaxed"
              initial={{ opacity: 0, y: 50 }}
              animate={{ opacity: 1, y: 0 }}
